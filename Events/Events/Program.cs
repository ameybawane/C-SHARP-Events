 ...
 * need to respond to events when they occur. For example, interrupts. 
 ...
 * other class. The class containing the event is used to publish the event. 
 ...
 * delegate. The event-delegate association is also defined in this object. 
 ...
 * handler. The delegate in the publisher class invokes the method (event handler) 
 * of the subscriber class.
 * 
 * Declaring Events: 
 * To declare an event inside a class, first of all, 
 * you must declare a delegate type for the even as:
    ...
    internal class Program
    {
        ...
        class EventProgram
        {
            ...
            static void Main(string[] args)
            {
                ...
                string result = obj1.MyEvent("Amey Bawane...");
